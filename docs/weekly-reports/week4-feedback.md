...
**Dedicated PM/TA**: Eiko Reisz (eikoreisz2026@u.northwestern.edu)
...
| 3.1 | Every functionality-related work item on the management board includes a user story, and optionally one or more use cases.                                   |      ⚠️     |  Use cases and user stories can be found in the design docs folder, but not on individual items on the management board                   | Week 4 Wednesday Lecture (Lecture 08), Canvas assignment Project: Week 4 Guidance |
| 3.2 | The design is documented somewhere, either in the work item description, or in a separate design document.                                                   |      ✅     | I would appreciate it if there was a central place (e.g. docs/design) where I can find system / individual class designs                   | Week 4 Wednesday Lecture (Lecture 08), Canvas assignment Project: Week 4 Guidance |
...
| 4   | Each active feature branch has an open draft PR against main.                                                                                                |     ⚠️     | StartingNewGame/InitializeMapTerritories should have a PR draft.                    | Week 4 Wednesday Lecture (Lecture 08)                                             |
| 5   | The team has a “definition of done” (BVA) fully documented for the part of the system that is done. (needed for Letter Grade D)                              |     ❌      | No BVA documents found in the BVA document folder                    | Project grading rubrics                                                           |
...
| # | Item                                                                                                                                                         |  Status   | Reviewer Notes      | Source Instructions or Resources                                                  |
|---|--------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------:|---------------------|-----------------------------------------------------------------------------------|
| 7 | The team documents every week’s planning and progress evaluation professionally. (needed for Letter Grade B)                                                 |    ✅       |                     | Week 4 Wednesday Lecture (Lecture 08), Project grading rubrics                    |

### Progress & Collaboration
| #  | Item                                                                                                                                                             |  Status   | Reviewer Notes      | Source Instructions or Resources                                                  |
|----|------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------:|---------------------|-----------------------------------------------------------------------------------|
| 8  | README is updated properly, including the project name, contributors, and build status badge. In addition, the team should specify the GUI library if appliable. |    ✅       |                     | Canvas assignment Project: Setup                                                  |
| 9  | Overall progress on "Game Setup Phase"                                                                                                                           |    ✅       |                     | Canvas assignment Project: Week 4 Guidance                                        |
| 10 | Collaboration: Quality of discussion in PR reviews and work item comments on the board.                                                                          |    ⚠️       | Please add a comment whenever reviewing/accepting a PR          |                                                                                   |

## Additional Comments
Good job. One final note, please delete branches once they have been merged into main
